...
export declare const DOGE_MAINNET: DogeNetworkParams;
export declare const DOGE_TESTNET: DogeNetworkParams;
...
export declare const KOINU_PER_DOGE = 100000000;
/** Convert DOGE to koinu */
export declare function dogeToKoinu(doge: number): number;
/** Convert koinu to DOGE */
export declare function koinuToDoge(koinu: number): number;
