...
export class ProviderError extends WalletError {
    provider;
    statusCode;
    constructor(provider, message, statusCode) {
...
export class ProviderUnavailableError extends WalletError {
    ...
    constructor(providers) {
        super("PROVIDER_UNAVAILABLE", `All API providers are down (${providers.join(", ")}). Much sadness. Very offline. 🐕`);
...
export class WalletNotInitializedError extends WalletError {
    constructor() {
        super("WALLET_NOT_INITIALIZED", "No wallet configured. Run /wallet init to get started. Such empty. 🐕");
...
export class InsufficientFundsError extends WalletError {
    required;
    available;
    constructor(messageOrRequired, available) {
        if (typeof messageOrRequired === "string") {
            ...
            super("INSUFFICIENT_FUNDS", `Insufficient funds: need ${messageOrRequired} koinu but only have ${available} koinu. Much broke. 🐕`);
            this.name = "InsufficientFundsError";
...
export class WalletAlreadyInitializedError extends WalletError {
    constructor() {
        super("WALLET_ALREADY_INITIALIZED", "Wallet already exists. Use /wallet recover to restore from mnemonic, " +
...
export class WalletLockedError extends WalletError {
    constructor() {
        super("WALLET_LOCKED", "Wallet is locked. Use /wallet unlock to decrypt the keystore. Much secure. 🔒🐕");
...
export class InvalidPassphraseError extends WalletError {
    constructor() {
        super("INVALID_PASSPHRASE", "Invalid passphrase — could not decrypt keystore. Such wrong. Very try again. 🐕");
...
export class InvalidMnemonicError extends WalletError {
    constructor() {
        super("INVALID_MNEMONIC", "Invalid mnemonic phrase. Must be a valid BIP39 24-word mnemonic. Much words. Very check. 🐕");
