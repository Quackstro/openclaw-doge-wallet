 ...
 */
export function build2of2RedeemScript(pubkey1, pubkey2) {
 ...
 */
export function createMultisig(consumerPubkey, providerPubkey) {
 ...
 */
export function buildMultisigScriptSig(sig1, sig2, redeemScript) {
    const parts = [];
 ...
 */
export function parseMultisigScript(script) {
    if (script.length !== 71) {
 ...
 */
export function getSignatureOrder(redeemScript, consumerPubkey, providerPubkey) {
