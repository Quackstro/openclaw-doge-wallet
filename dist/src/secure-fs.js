 ...
 */
export async function secureMkdir(dirPath) {
 ...
 */
export function secureWriteFileSync(filePath, data) {
    const { chmodSync } = require("node:fs");
 ...
 */
export async function secureAppendFile(filePath, data) {
    await secureMkdir(dirname(filePath));
 ...
 */
export async function ensureSecureDataDir(dataDir) {
