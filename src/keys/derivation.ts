 ...
 */
function getNetworkParams(network: "mainnet" | "testnet"): DogeNetworkParams {
 ...
 */
function encodeAddress(pubKeyHash: Buffer, versionByte: number): string {
...
export function isValidAddress(
  ...
  try {
    ...
    return (
      versionByte === params.pubKeyHash || versionByte === params.scriptHash
    );
  } catch {
    return false;
  }
