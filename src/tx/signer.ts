 ...
 */
function generateScriptPubKey(address: string, bitcore: any): string {
...
export function signTransaction(
  ...
  const bitcoreNetwork =
    network === "testnet" ? Networks.testnet : Networks.livenet;
  ...
  let privKey: typeof BPrivateKey | null = new BPrivateKey(bn, bitcoreNetwork, true);
